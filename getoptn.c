...
main (int argc, char * argv [])
{
  ...
  getoptn_opt_t opts [] = {
    { "-D",     &s, (void * ) "abc123",   NULL, NULL, sizeof (s),   GETOPTN_STRING },
    { "-b",     &i, NULL,                 NULL, NULL, sizeof (i),   GETOPTN_BOOL },
    { "--b",    &i, NULL,                 NULL, NULL, sizeof (i),   GETOPTN_BOOL },
    { "-c",     &j, NULL,                 NULL, NULL, sizeof (j),   GETOPTN_BOOL },
    { "--c",    (void * ) "-c", NULL,     NULL, NULL, 0,            GETOPTN_ALIAS },
    { "-bc",    &k, NULL,                 NULL, NULL, sizeof (k),   GETOPTN_BOOL },
    { "-d",     &d, NULL,                 NULL, NULL, sizeof (d),   GETOPTN_DOUBLE },
    { "-f1",    &i, NULL,                 NULL, NULL, 8,            GETOPTN_INT },
    { "-f2",    &i, NULL,                 NULL, NULL, 2,            GETOPTN_LONG },
    { "-f3",    &l, NULL,                 NULL, NULL, 12,           GETOPTN_LONG },
    { "--i",    &i, NULL,                 NULL, NULL, sizeof (i),   GETOPTN_INT },
    { "-i",     &i, NULL,                 NULL, NULL, sizeof (i),   GETOPTN_INT },
    { "-i15",   &j, NULL,                 NULL, NULL, sizeof (j),   GETOPTN_INT },
    { "-i17",   &j, NULL,                 NULL, NULL, sizeof (j),   GETOPTN_INT },
    { "-l",     &l, NULL,                 NULL, NULL, sizeof (l),   GETOPTN_LONG },
    { "-s",     &s, NULL,                 NULL, NULL, sizeof (s),   GETOPTN_STRING },
    { "-sabcd", &i, NULL,                 NULL, NULL, sizeof (i),   GETOPTN_BOOL },
    { "-sp",    &sp, NULL,                NULL, NULL, 0,            GETOPTN_STRPTR },
    { "-p",     &sp, NULL,                NULL, NULL, 0,            GETOPTN_STRPTR },
    { "-S",     &sp, (void * ) "abc1234", NULL, NULL, 0,            GETOPTN_STRPTR },
    { "-s2",    &s2, NULL,                NULL, NULL, sizeof (s2),  GETOPTN_STRING },
    { "-np1",   NULL, NULL,               NULL, NULL, sizeof (s2),  GETOPTN_STRING },
    { "-np2",   NULL, NULL,               NULL, NULL, sizeof (s2),  GETOPTN_FUNC_BOOL },
    { "-np3",   NULL, NULL,               NULL, NULL, sizeof (s2),  GETOPTN_FUNC_VALUE },
    { "-w",     NULL, NULL,               NULL, NULL, 0,            GETOPTN_IGNORE },
    { "-W",     NULL, NULL,               NULL, NULL, 0,            GETOPTN_IGNORE_ARG },
    { "-z1",    (void * ) "--c", NULL,    NULL, NULL, 0,            GETOPTN_ALIAS },
    { "-z2",    (void * ) "-z1", NULL,    NULL, NULL, 0,            GETOPTN_ALIAS },
    { "-z3",    (void * ) "-z2", NULL,    NULL, NULL, 0,            GETOPTN_ALIAS }
  };
